...
/* harmony export */   "renderTodayList": () => (/* binding */ renderTodayList)
/* harmony export */ });
...
function renderTodayList() {
    _listData__WEBPACK_IMPORTED_MODULE_0__.timeObjects[0].compileArray();
    let domList = createList(_listData__WEBPACK_IMPORTED_MODULE_0__.timeObjects[0]);
    domList.openList();
...
const createDetailsBox = (state) => ({
    createDetailsBox() {
        ...
        if (state.due) {
            ...
            let formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(state.due, "PPPP");
...
function convertFormToData() {
    ...
    if (due) {
        due = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(due);
    }
    let priority;
...
function openForm(type) {
    ...
    if (type === "New Project") {
        inputType = "project"
    } else if (_dom__WEBPACK_IMPORTED_MODULE_1__.currentList.type === "time") {
        inputType = "time";
        restrictDateInput();
...
let todayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])();
let tomorrow = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(todayDate, { days: 1 });
let thisWeekDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(todayDate, { weeks: 1 });
let nextWeekDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(todayDate, { weeks: 2 });
todayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(todayDate, "yyyy-MM-dd");
tomorrow = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(tomorrow, "yyyy-MM-dd");
thisWeekDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(thisWeekDate, "yyyy-MM-dd");
nextWeekDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(nextWeekDate, "yyyy-MM-dd");

function restrictDateInput() {
    if (_dom__WEBPACK_IMPORTED_MODULE_1__.currentList.title === "Today") {
        input.due.setAttribute("value", todayDate);
        input.due.setAttribute("disabled", true);
    } else if (_dom__WEBPACK_IMPORTED_MODULE_1__.currentList.title === "This Week") {
        input.due.setAttribute("value", tomorrow);
        input.due.setAttribute("min", tomorrow);
        input.due.setAttribute("max", thisWeekDate);
    } else if (_dom__WEBPACK_IMPORTED_MODULE_1__.currentList.title === "Next Week") {
        input.due.setAttribute("value", thisWeekDate);
        input.due.setAttribute("min", thisWeekDate);
        input.due.setAttribute("max", nextWeekDate);
    } else if (_dom__WEBPACK_IMPORTED_MODULE_1__.currentList.title === "Future") {
...
submitBtn.addEventListener("click", () => {
    ...
    if (inputType === "project") {
        ...
        if (!_listData__WEBPACK_IMPORTED_MODULE_0__.allProjects[projectTitle]) {
            (0,_listData__WEBPACK_IMPORTED_MODULE_0__.addProject)(projectTitle);
        }
        const newItem = (0,_listData__WEBPACK_IMPORTED_MODULE_0__.addListItem)(...input, projectTitle);
        newItem.addToProject();
        (0,_dom__WEBPACK_IMPORTED_MODULE_1__.appendNewItem)(newItem);
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
    (0,_dom_js__WEBPACK_IMPORTED_MODULE_1__.renderTodayList)();
