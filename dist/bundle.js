...
/* harmony export */   "allProjects": () => (/* reexport safe */ _init__WEBPACK_IMPORTED_MODULE_0__.allProjects),
...
const timeMethods = {
    compileArray() {
        this.items = [];
        for (let project in _init__WEBPACK_IMPORTED_MODULE_0__.allProjects) {
            if (_init__WEBPACK_IMPORTED_MODULE_0__.allProjects[project].items) {
                for (let item of _init__WEBPACK_IMPORTED_MODULE_0__.allProjects[project].items) {
                    if (item.due) {
...
let todayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])();
let tomorrow = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(todayDate, { days: 1 });
let thisWeekDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(todayDate, { weeks: 1 });
let nextWeekDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(todayDate, { weeks: 2 });
...
const projectMethods = {
    deleteProject() {
        delete _init__WEBPACK_IMPORTED_MODULE_0__.allProjects[this.title];
    }
}
...
function addProject(title, notes, due, priority) {
    ...
    project.items = [];
    _init__WEBPACK_IMPORTED_MODULE_0__.allProjects[project.title] = project;
    localStorage.setItem("savedData", _init__WEBPACK_IMPORTED_MODULE_0__.allProjects);
    return project;
}

const itemMethods = {
    addToProject() {
        _init__WEBPACK_IMPORTED_MODULE_0__.allProjects[this.project].items.push(this);
        localStorage.setItem("savedData", _init__WEBPACK_IMPORTED_MODULE_0__.allProjects);
    },
    removeFromProject() {
        const index = _init__WEBPACK_IMPORTED_MODULE_0__.allProjects[this.project].items.indexOf(this);
        _init__WEBPACK_IMPORTED_MODULE_0__.allProjects[this.project].items.splice(index, 1);
        localStorage.setItem("savedData", _init__WEBPACK_IMPORTED_MODULE_0__.allProjects);
    }
}
